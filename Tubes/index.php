...
<body>
    ...
    <main role="main">
      ...
      <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/1.jpeg" alt="Generic placeholder image" width="140" height="140">
            <h2>Nur Tri Ramadhanti</h2>
            <p>______________</p>
            <p>(1204061)</p>
            <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/3.jpeg" alt="Generic placeholder image" width="140" height="140">
            <h2>Algies Rifkha Fadillah</h2>
            <p>______________</p>
            <p>(12204063)</p>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="image/2.jpeg" alt="Generic placeholder image" width="140" height="140">
            <h2>Hasna Zahidah</h2>
            <p>______________</p>
            <p>(1207068)</p>
