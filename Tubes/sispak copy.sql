...
(001, 'PTSD', '', 'pakar', 'setuju'),
(002, 'Depresi', '', 'pakar', 'setuju'),
(003, 'Skizofrenia', '', 'pakar', 'setuju');
...
CREATE TABLE `tb_pertanyaan` (
  ...
  `isi_pertanyaan` varchar(5000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('m2', 'Apakah terkadang anda teringat kejadian traumatis secara berulang ? (dapat berupa mimpi)'),
('m3', 'Apakah anda sering menghindari objek yang berkaitan dengan rasa traumatis anda ? '),
('m4', 'Apakah Anda Kesulitan mengingat aspek penting kejadian traumatis ? (kejadian yang terlupakan)'),
('m5', 'Apakah Anda Memiliki keyakinan negative yang bertahan lama ? (contoh: aku adalah orang yang buruk)'),
('m6', 'Apakah Anda Merasa takut, marah, sedih, atau malu secara berlebihan ?'),
('m7', 'Apakah Anda Kehilangan minat dalam beraktivitas ?'),
('m8', 'Apakah Anda Merasa tidak bahagia ?'),
('m9', 'Apakah Anda Mudah marah, gelisah, menyakiti diri, atau kaget secara berlebihan ?'),
('m10', 'Apakah Anda Mengalami gangguan tidur ?'),
('m11', 'Apakah Anda Merasa sedih secara mendalam ?'),
('m12', 'Apakah Anda Mengalami Penurunan minat dalam hobi atau kegemaran hampir setiap hari ?'),
('m13', 'Apakah Anda Merasa bersalah atau tidak berguna atau putus harapan ?'),
('m14', 'Apakah Anda Hilang energy atau merasa lemas menjalani hari ?'),
('m15', 'Apakah Anda Mengalami Perubahan berat badan secara drastis ?'),
('m16', 'Apakah Anda Kesulitan dalam berkonsentrasi dibanding sebelumnya ?'),
('m17', 'Apakah Anda Merasa gemetar atau gelisah ?'),
('m18', 'Apakah Anda Merasa dunia bergerak sangat lamban ?'),
('m19', 'Apakah Anda Merasa ingin bunuh diri ?'),
('m20', 'Apakah Anda Mengalami delusi atau keyakinan kuat yang sulit diubah ?'),
('m21', 'Apakah Anda Mengalami halusinasi atau menangkap sesuatu yang tidak ada ?'),
('m22', 'Apakah Anda Merasa Cara bicara anda tidak nyambung ?'),
('m23', 'Apakah Anda Selalu memasang wajah datar dalam berekspresi sedih, senang, atau marah?'),
('m24', 'Apakah Anda Kesulitan memulai aktivitas sehari-hari seperti mandi, makan, atau berpakaian ?'),
('m25', 'Apakah Anda Kehilangan minat dalam bersosialisasi ?'),
('m26', 'Apakah Terkadang Anda Melakukan pose tertentu dalam waktu lama seperti beralih dari sangat aktif ke diam dalam sekejap dan sebaliknya ?');
